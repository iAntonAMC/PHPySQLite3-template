<?php session_start(); ?>
<?php require "consultas/un_cliente.php"?>
<!DOCTYPE html>
<html lang="en">
...
<h1>Actualizar Cliente</h1>
        ...
        <form name="Cliente" method="POST" action="/consultas/actualizar_cliente.php">
            <div class="mb-3">
            ...
            <input type="button" class='btn btn-primary' onclick="submit()" value="Actualizar">
